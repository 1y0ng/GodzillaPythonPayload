...
package shells.payloads.python;
...
@PayloadAnnotation(
        Name = "PythonDynamicPayload"
)
public class PythonShell implements Payload {
    ...
    public byte[] getPayload() {
        ...
        try {
            InputStream fileInputStream = PythonShell.class.getResourceAsStream("assets/payload.py");
